...
const BOT_NAME_FANCY = '—͟͞͞★ᴅᴛᴢ ɴᴏᴠᴀ x ᴍᴅㅤ✓';
...
const config = {
  ...
  BOT_NAME: '—͟͞͞★ᴅᴛᴢ ɴᴏᴠᴀ x ᴍᴅㅤ✓',
  BOT_VERSION: '1.0.0V',
  OWNER_NAME: 'AKARSHANA',
  IMAGE_PATH: 'https://files.catbox.moe/l74kdf.jpg',
  BOT_FOOTER: '> 𝙿𝙾𝚆𝙴𝚁𝙳 𝙱𝚈 —͟͞͞★ᴅᴛᴢ ɴᴏᴠᴀ x ᴍᴅㅤ✓ 𝙾𝙵𝙲 ',
...
// ========== END WORK TYPE RESTRICTIONS ==========
    ...
    let botName = cfg.botName || '—͟͞͞★ᴅᴛᴢ ɴᴏᴠᴀ x ᴍᴅㅤ✓';
 ...
 case 'weather':
    try {
        ...
        const messages = {
            ...
            weather: (data) => `
*☘️ —͟͞͞★ᴅᴛᴢ ɴᴏᴠᴀ x ᴍᴅㅤ✓ 𝐖eather 𝐑eport ☘️*
...
*—͟͞͞★ᴅᴛᴢ ɴᴏᴠᴀ x ᴍᴅㅤ✓*`
  ...
  case 'cricket':
    try {
        ...
        await socket.sendMessage(sender, {
            text: formatMessage(
                '*🏏 —͟͞͞★ᴅᴛᴢ ɴᴏᴠᴀ x ᴍᴅㅤ✓ 𝐂ᴇɪᴄᴋᴇᴛ 𝐍ᴇᴡꜱ🏏*',
                `📢 *${title}*\n\n` +
                `🏆 *mark*: ${score}\n` +
                `🎯 *to win*: ${to_win}\n` +
                `📈 *now speed*: ${crr}\n\n` +
...
END:VCARD`
    ...
    const text = `
👑 *—͟͞͞★ᴅᴛᴢ ɴᴏᴠᴀ x ᴍᴅㅤ✓ OWNER*

*👤 𝐍ame: AKARSHANA*
*📞 𝐍umber: +94714768679*

> 𝐏𝙾𝚆𝙴𝚁𝙴𝙳 𝐁𝚈 —͟͞͞★ᴅᴛᴢ ɴᴏᴠᴀ x ᴍᴅㅤ✓
`.trim();
...
END:VCARD` } }
        ...
        const buttonMessage = {
            ...
            footer: config.FOOTER || '> *—͟͞͞★ᴅᴛᴢ ɴᴏᴠᴀ x ᴍᴅㅤ✓*',
            buttons: buttons,
             headerType: 4,
            contextInfo: { mentionedJid: [sender] }
        };
...
case 'jid': {
    const sanitized = (number || '').replace(/[^0-9]/g, '');
    const cfg = await loadUserConfigFromMongo(sanitized) || {};
    const botName = cfg.botName || '—͟͞͞★ᴅᴛᴢ ɴᴏᴠᴀ x ᴍᴅㅤ✓'; // dynamic bot name
